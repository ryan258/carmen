...
- Moved location metadata to `data/argentina-regions.json` and citations to `data/sources.json`.
...
### Technical
- Split assets: `carmen-sandiego-argentina.html`, `styles.css`, `game.js`, reusable `run-generator.js`, content in `question-bank.json`.
